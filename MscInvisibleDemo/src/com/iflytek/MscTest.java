...
public class MscTest {
	...
	private static final String APPID = "5b7e899e";
...
//				"./iat_test.pcm");
		...
		try {
			fis = new FileInputStream(new File("C:\\Users\\20785\\Downloads\\Java_iat1019_5b7e899e\\sample\\MscInvisibleDemo\\test.pcm"));
			if (0 == fis.available()) {
